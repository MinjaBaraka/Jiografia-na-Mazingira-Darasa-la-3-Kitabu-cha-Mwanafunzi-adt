"""Version all Zoezi narration clips so stale online caches cannot reuse them."""

import json
from pathlib import Path

from rehema_speech import ZOEZI_PATTERN
...
def main() -> None:
    ...
    for text_id in affected:
        ...
        new_name = f"{text_id}_rehema_zoezi_v1.mp3"
    ...
    print(f"Versioned {len(affected)} Zoezi narration clips")
