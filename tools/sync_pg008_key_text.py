...
LABELS = {
    "pg008_n0007": "Mabara — rangi ya kijani",
    "pg008_n0008": "Bahari — rangi ya bluu",
    "pg008_n0007_easy_read": "Mabara — rangi ya kijani",
    "pg008_n0008_easy_read": "Bahari — rangi ya bluu",
}
...
def main():
    ...
    for text_id, label in LABELS.items():
        old = f'"{text_id}":"Mabara"' if "n0007" in text_id else f'"{text_id}":"Bahari"'
